...
document.addEventListener("DOMContentLoaded", () => {
    ...
    accountWindow.innerHTML = `
        ...
        <ul style="list-style:none; padding:0; margin:0;">
            <li><a href="/dashboard/account/profile.html" style="text-decoration:none; color:#333;">Profile</a></li>
            <li><a href="/dashboard/account/settings.html" style="text-decoration:none; color:#333;">Settings</a></li>
